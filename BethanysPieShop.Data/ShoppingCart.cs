...
namespace BethanysPieShop.Data
{
    public class ShoppingCart : IShoppingCart
    {
        ...
        {
            return ShoppingCartItems ??= bethanysPieShopDbContext.ShoppingCartItems.Where(
        ...
        {
            var cartItems = bethanysPieShopDbContext.ShoppingCartItems.Where(
        ...
        {
            var total = bethanysPieShopDbContext.ShoppingCartItems.Where(
                c => c.ShoppingCartId == ShoppingCartId)
